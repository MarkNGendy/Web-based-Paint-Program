...
public class HomeController {
    ...
    Board modifyShapes(@RequestBody RequestBodyForm requestBodyForm) {
         ...
         * 
         * Shape requiredShape = shapeFactory.createShape(requiredShapeType,
         * requiredShapePoints);
         * 
         * int indexOfShape = requestBodyForm.shape.getIndexInBoard();
         */
        Shape requiredShape = requestBodyForm.shape;
        int indexOfShape = requiredShape.getIndexInBoard();
        ...
        switch (requestBodyForm.operation) {
            ...
            case UPDATE: {
                board.updateShape(indexOfShape, requiredShape);
                break;
            }
            case DELETE: {
                board.deleteShape(indexOfShape);
            }
        }
